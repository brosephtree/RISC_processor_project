...
# Switches
set_property PACKAGE_PIN V17 [get_ports display_sel]					
	set_property IOSTANDARD LVCMOS33 [get_ports display_sel]
set_property PACKAGE_PIN V16 [get_ports dump_mem]					
	set_property IOSTANDARD LVCMOS33 [get_ports dump_mem]
...
set_property PACKAGE_PIN W19 [get_ports step_mem_btn]						
	set_property IOSTANDARD LVCMOS33 [get_ports step_mem_btn]
#set_property PACKAGE_PIN T17 [get_ports btnR]						
	#set_property IOSTANDARD LVCMOS33 [get_ports btnR]
set_property PACKAGE_PIN U17 [get_ports step_clk_btn]						
	set_property IOSTANDARD LVCMOS33 [get_ports step_clk_btn]
